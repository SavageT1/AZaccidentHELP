...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 font-sans text-zinc-100 p-4 sm:p-6 flex flex-col selection:bg-primary selection:text-black">
      {/* Navigation */}
      ...
      {/* Bento Grid Layout */}
      <div className="grid grid-cols-12 gap-4 flex-grow max-w-[1400px] mx-auto w-full">
        ...
        <motion.div 
          ...
          className="col-span-12 lg:col-span-8 bg-zinc-900 border border-zinc-800 rounded-[2rem] p-8 lg:p-12 relative overflow-hidden flex flex-col justify-center"
        >
          ...
          <div className="relative z-10">
            ...
            <h1 className="text-5xl md:text-[80px] font-black leading-[0.9] tracking-tight mb-6 uppercase">
              INJURED IN AZ?<br/>
              <span className="text-primary underline decoration-primary/30 decoration-8 underline-offset-8">WE FIGHT FOR YOU.</span>
            </h1>
            <p className="text-zinc-400 text-xl max-w-lg mb-10 font-medium leading-relaxed">
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
          className="col-span-12 md:col-span-6 lg:col-span-4 bg-white rounded-[2rem] p-8 shadow-2xl relative"
        >
        ...
        <motion.div 
          ...
          whileInView={{ opacity: 1, scale: 1 }}
          viewport={{ once: true }}
          className="col-span-12 md:col-span-6 lg:col-span-4 bg-zinc-950 border border-zinc-800 rounded-[2rem] p-8 relative overflow-hidden"
        >
          <SuccessStories />
        ...
        <motion.div 
          ...
          whileInView={{ opacity: 1, scale: 1 }}
          viewport={{ once: true }}
          className="col-span-12 lg:col-span-4 bg-primary rounded-[2rem] p-8 shadow-primary-glow relative"
        >
          <h3 className="text-2xl font-black mb-6 uppercase tracking-tight text-black">Free Evaluation</h3>
          <LeadForm />
        ...
        <motion.div 
          ...
          whileInView={{ opacity: 1, scale: 1 }}
          viewport={{ once: true }}
          className="col-span-12 md:col-span-8 bg-zinc-900 border border-zinc-800 rounded-[2rem] p-10 group overflow-hidden relative"
        >
          <div className="flex justify-between items-start mb-10">
            <div>
              ...
              <p className="text-sm font-bold text-zinc-400 uppercase tracking-[0.2em] mt-4">Essential legal guides for accident victims</p>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 relative z-10">
            {BLOG_POSTS.slice(0, 3).map((post) => (
              <div key={post.id} className="flex flex-col gap-4 p-6 rounded-2xl bg-zinc-800/50 hover:bg-zinc-800 transition-colors cursor-pointer group/item border border-zinc-700/30">
        ...
        <motion.div 
          ...
          whileInView={{ opacity: 1, scale: 1 }}
          viewport={{ once: true }}
          className="col-span-12 md:col-span-4 bg-zinc-100 rounded-[2rem] p-10 flex flex-col justify-center text-zinc-950 border border-zinc-200"
        >
           <div className="mb-6">
           ...
           <div className="space-y-4">
              <a href="tel:1800AZHELP" className="flex items-center justify-between p-6 rounded-2xl bg-white shadow-sm hover:shadow-xl transition-all group">
